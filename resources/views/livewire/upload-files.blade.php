<div>
    ...
    {{-- <div wire:loading wire:target="photo">Uploading...</div> Loading indicator
    <div wire:loading wire:target="save">Storing photos...</div> Loading indicator --}}
    ...
    <input type="file" multiple wire:model="photos"  class="w-full h-40 rounded-lg text-center text-gray-500 p-16 cursor-pointer border border-dashed border-gray-500"
